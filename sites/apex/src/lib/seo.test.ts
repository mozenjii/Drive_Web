...
const prospect: Prospect = {
  slug: 'sample', name: 'Sample Driving School', short: 'Sample', city: 'Riverside', county: 'Riverside County',
  phone: '(951) 555-0100', phoneRaw: '+19515550100', years: '1', hourly: 85, areas: ['Riverside'], instructors: [],
};
